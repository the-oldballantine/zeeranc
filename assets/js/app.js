...
document.addEventListener('DOMContentLoaded', function () {
    if (document.querySelectorAll('#map').length > 0) {
		...
		js_file.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyDU-i29cL4-qND9aOnK5QLgSIUI-RrKPMw&callback=initMap&language=' + lang;
...
function initMap() {
    var markerPosition = new google.maps.LatLng(35.595761, -78.777147);
	var image = {
	...
	var mapOptions = {
		zoom: 17,
		center: new google.maps.LatLng(35.595761, -78.777147),
	...
	function changeIntroElement() {
		$('.el-intro .link-hover').on('click', function (e) {
			...
			if ($that.hasClass('intro-with-page-header')) {
				var header = $that.text();
				$('.el-page-intro .intro-content-wrapper').html('<div class="intro-content"><div class="page-header-intro"><div class="page-header"><div class="header"><h3>Intro with element page header</h3><div class="post-meta"><ul><li>Share on:</li><li><a href="#" class="link-hover">facebook</a></li><li><a href="#" class="link-hover">twitter</a></li><li><a href="#" class="link-hover">trip advisor</a></li></ul></div></div></div></div></div>');
			}
		});
	}
